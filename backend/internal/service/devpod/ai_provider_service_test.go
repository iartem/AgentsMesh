...
func TestCreateUserProvider(t *testing.T) {
	...
	provider, err := service.CreateUserProvider(ctx, 1, devpod.AIProviderTypeClaude, "My Claude", credentials, true)
	if err != nil {
	...
	if provider.ProviderType != devpod.AIProviderTypeClaude {
		t.Errorf("expected ProviderType '%s', got '%s'", devpod.AIProviderTypeClaude, provider.ProviderType)
	}
...
func TestGetUserProviders(t *testing.T) {
	...
	_, err := service.CreateUserProvider(ctx, 1, devpod.AIProviderTypeClaude, "Claude 1", creds, true)
	if err != nil {
		t.Fatalf("failed to create provider: %v", err)
	}
	_, err = service.CreateUserProvider(ctx, 1, devpod.AIProviderTypeOpenAI, "OpenAI", creds, false)
	if err != nil {
		t.Fatalf("failed to create provider: %v", err)
	}
	_, err = service.CreateUserProvider(ctx, 2, devpod.AIProviderTypeClaude, "Other User", creds, true)
	if err != nil {
		t.Fatalf("failed to create provider: %v", err)
	}
...
func TestGetUserProvidersByType(t *testing.T) {
	...
	_, err = service.CreateUserProvider(ctx, 1, devpod.AIProviderTypeClaude, "Claude 2", creds, false)
	if err != nil {
		t.Fatalf("failed to create provider: %v", err)
	}
	_, err = service.CreateUserProvider(ctx, 1, devpod.AIProviderTypeOpenAI, "OpenAI", creds, false)
	...
	providers, err := service.GetUserProvidersByType(ctx, 1, devpod.AIProviderTypeClaude)
	if err != nil {
		t.Fatalf("failed to get providers: %v", err)
	}
	...
	for _, p := range providers {
		if p.ProviderType != devpod.AIProviderTypeClaude {
...
func TestUpdateUserProvider(t *testing.T) {
	...
	provider, err := service.CreateUserProvider(ctx, 1, devpod.AIProviderTypeClaude, "Original", creds, false)
	if err != nil {
		t.Fatalf("failed to create provider: %v", err)
	}
...
func TestDeleteUserProvider(t *testing.T) {
	...
	// Create a provider
	creds := map[string]string{"api_key": "test"}
	provider, err := service.CreateUserProvider(ctx, 1, devpod.AIProviderTypeClaude, "To Delete", creds, false)
	if err != nil {
		t.Fatalf("failed to create provider: %v", err)
	}
...
func TestSetDefaultProvider(t *testing.T) {
	...
	creds := map[string]string{"api_key": "test"}
	p1, err := service.CreateUserProvider(ctx, 1, devpod.AIProviderTypeClaude, "Claude 1", creds, true)
	if err != nil {
		t.Fatalf("failed to create provider: %v", err)
	}
	p2, err := service.CreateUserProvider(ctx, 1, devpod.AIProviderTypeClaude, "Claude 2", creds, false)
	if err != nil {
		t.Fatalf("failed to create provider: %v", err)
	}
	...
	var provider1 devpod.UserAIProvider
	...
	var provider2 devpod.UserAIProvider
...
func TestGetProviderCredentials(t *testing.T) {
	...
	provider, err := service.CreateUserProvider(ctx, 1, devpod.AIProviderTypeClaude, "Claude", creds, true)
	if err != nil {
		t.Fatalf("failed to create provider: %v", err)
	}
...
func TestGetUserDefaultCredentials(t *testing.T) {
	...
	_, err := service.CreateUserProvider(ctx, 1, devpod.AIProviderTypeClaude, "Claude 1", creds1, false)
	if err != nil {
		t.Fatalf("failed to create provider: %v", err)
	}
	_, err = service.CreateUserProvider(ctx, 1, devpod.AIProviderTypeClaude, "Claude 2", creds2, true)
	if err != nil {
		t.Fatalf("failed to create provider: %v", err)
	}

	// Get default credentials
	creds, err := service.GetUserDefaultCredentials(ctx, 1, devpod.AIProviderTypeClaude)
	if err != nil {
...
func TestGetUserDefaultCredentials_NotFound(t *testing.T) {
	...
	_, err := service.GetUserDefaultCredentials(ctx, 1, devpod.AIProviderTypeClaude)
	if err != ErrProviderNotFound {
		t.Errorf("expected ErrProviderNotFound, got %v", err)
	}
}
...
func TestValidateCredentials(t *testing.T) {
	...
	tests := []struct {
	...
	}{
		{
			...
			providerType: devpod.AIProviderTypeClaude,
		...
		},
		{
			...
			providerType: devpod.AIProviderTypeOpenAI,
			credentials:  map[string]string{"api_key": "sk-test"},
			expectError:  false,
		},
		{
		...
		},
		{
			...
			providerType: devpod.AIProviderTypeGemini,
...
func TestFormatEnvVars(t *testing.T) {
	...
	t.Run("claude credentials", func(t *testing.T) {
		...
		envVars := service.formatEnvVars(devpod.AIProviderTypeClaude, creds)
	...
	t.Run("openai credentials", func(t *testing.T) {
		...
		envVars := service.formatEnvVars(devpod.AIProviderTypeOpenAI, creds)
...
func TestGetAIProviderEnvVars(t *testing.T) {
	...
	_, err := service.CreateUserProvider(ctx, 1, devpod.AIProviderTypeClaude, "Default Claude", creds, true)
	if err != nil {
		t.Fatalf("failed to create provider: %v", err)
	}
...
func TestUpdateUserProvider_WithCredentials(t *testing.T) {
	...
	// Create a provider
	creds := map[string]string{"api_key": "old-key"}
	provider, _ := service.CreateUserProvider(ctx, 1, devpod.AIProviderTypeClaude, "Claude", creds, false)
...
func TestFormatEnvVars_Gemini(t *testing.T) {
	...
	envVars := service.formatEnvVars(devpod.AIProviderTypeGemini, creds)
...
func TestCreateUserProvider_SetsDefault(t *testing.T) {
	...
	p1, _ := service.CreateUserProvider(ctx, 1, devpod.AIProviderTypeClaude, "Claude 1", creds, true)

	// Create second default provider of same type
	p2, _ := service.CreateUserProvider(ctx, 1, devpod.AIProviderTypeClaude, "Claude 2", creds, true)
